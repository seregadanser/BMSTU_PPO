...
namespace DB_course.Presenter
{
    public class WorkerPresenter
    {
        ...
        private IEnumerable<History> historyList;
        ...
        public WorkerPresenter(IWorkerView view, IModel model)
        {
            ...
            this.historyBindingSource = new BindingSource();
            this.view = view;
            ...
            this.view.SetHistoryListBindingSource(historyBindingSource);
            LoadAllLists();
